        ...
        <div>
            <article>
                ...
                <div class="account_details">
                    ...
                    <form onsubmit="return validateDetails()" action = "includes/detailsLogic.php" method = "POST" id="detailsForm">
                        <label for="newPass">New Password:</label>
                        <input type="password" id="newPass" name="newPass" minlength="8">
                        <input type="submit" name="newPassSubmit" id="newPassSubmit" value="Change Password"><br>
                        <label for="newEmail">New Email:</label>
                        <input type="email" id="newEmail" name="newEmail">
                        <input type="submit" name="newEmailSubmit" id="newEmailSubmit" value="Change Email"><br>
                        <label for="newNumber">New Phone Number:</label>
                        <input type="tel" id="newNumber" name="newNumber" pattern="[0-9+-]{1,7}[0-9]{6,9}">
                        <input type="submit" name="newNumberSubmit" id="newNumberSubmit" value="Change Phone Number">
                    </form>    
                    </div>                
